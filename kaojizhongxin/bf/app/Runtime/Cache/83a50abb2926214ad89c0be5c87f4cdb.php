     ...
     <div class="form-group row">
      ...
      <div class="form-group row">
            ...
            <select class="form-control" id="bm_level">
            		  	<?php $__FOR_START_4324__=1;$__FOR_END_4324__=8;for($i=$__FOR_START_4324__;$i < $__FOR_END_4324__;$i+=1){ ?><option value="<?php echo ($i); ?>"  <?php if(($data3['bm_level']) == $i): ?>selected<?php endif; ?> ><?php echo ($i); ?> </option>
            ...
            <select class="form-control" id="bm_ylevel">
            			<option value="0">无</option>
            		  	 	<?php $__FOR_START_22861__=1;$__FOR_END_22861__=8;for($i=$__FOR_START_22861__;$i < $__FOR_END_22861__;$i+=1){ ?><option value="<?php echo ($i); ?>"  <?php if(($data3['bm_ylevel']) == $i): ?>selected<?php endif; ?> ><?php echo ($i); ?> </option>
            ...
            <input type="text" name="bm_name"  id="bm_kjj" class="form-control" placeholder="" value="<?php echo ($data2[0]["bm_name"]); ?>" readonly>
            <input type="hidden" id="bm_kjj_id" value="<?php echo ($data2[0]["bm_id"]); ?>">
            <input type="hidden" id="id" value="<?php echo ($_GET['id']); ?>">
            <button style="float:right; margin-top:10px;" type="button" onclick="bm_add1('kshd_update_ac','ksbm_select')" class="btn btn-default">修改</button>
        </div> 
