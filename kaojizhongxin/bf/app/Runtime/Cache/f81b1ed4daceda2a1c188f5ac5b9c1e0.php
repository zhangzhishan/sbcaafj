...
<div class="row" style="margin-top:30px;" >
	<div class="col-sm-10 col-sm-offset-1">
    <button style="float:right; margin-top:10px;" type="button" onclick="bm_add1('kshd_dy','ks_select')" class="btn btn-default">无误打印
          </button>
    		<button style="float:right; margin-top:10px;" type="button" onclick="bm_add1('kshd_sele','ks_select')" class="btn btn-default">有误上一步           </button>
          
    </div>
</div>

<script>
var kshd= eval(<?php echo ($data1); ?>);
